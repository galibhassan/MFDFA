...
from EMD.src.Frame import Frame
from EMD.src.Button import Button
from EMD.src.CheckButtons import CheckButtons

def emdDetrender(timeSeries):
    domain = range(len(timeSeries))
